...
//Tx(akkuL/2+xt90b-45) Tz(akkuH/2-240) Ry(20) Rz(180) Rx(180) rahmen();
...
*D() {
    U() {
        ...
        Tx(15)Ty(akkuB/2) {
            Tz(akkuH/2+wand-2) {
                 Tx(akkuL/2-30) myslide();
                 Tx(0) myslide();
                 Tx(-(akkuL/2-30)) myslide();
            }
            Tz(-akkuH/5+10) Tx(gehL/2+5) Ry(115) myslide();
            Tz(-akkuH/5+10) Tx(gehL/2+5) Ry(115) myslide(2);
            Tx(160) Ty(-akkuB/2) Tz(15) Ry(115) Cu(akkuH, akkuB,wand);
            Tx(120) Ty(-akkuB/2) Tz(akkuH/2) Ry(0) Cu(akkuH, akkuB,wand);
        }
    }
    Tz(akkuH/2-rund) Tx((akkuL+akkuH)/2) Ty(akkuB/2) Cu(akkuH, akkuB, xt90h*2+rund);
}

*Tz(akkuH/2-xt90h/2) Tx(akkuL/2+xt90b/2+25) Ty(-4) Ry(-90) import("XT90ConnectionPlate01.stl");

//Tx(60) Tz(-akkuH/2-20) Ry(0) Rz(90) Rx(180) 
Tx(40) Tz(-35) vesc_platinenhalter();
...
Tx(-10) Tz(-25) Cu(40,80, 2);
color("green")
Tx(-10) Tz(-20) Rx(90) Cu(10,10, 60);

module myslide(view=1)
{
					slide(
						Slide_length = akkuB,
						Slide_width = 40,
